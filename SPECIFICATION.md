...
Warp V2 is an enhanced cross-chain messaging (XCM) format building upon the original Warp protocol developed by the Avalanche team. This version introduces post-quantum safety through random corona validation and other cryptographic improvements while maintaining backward compatibility with Warp V1.

## Improvements over Warp V1

1. **Post-Quantum Safety**: Random corona validation provides resistance against quantum attacks
