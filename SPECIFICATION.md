...
Warp V2 is an enhanced cross-chain messaging (XCM) format building upon the original Warp protocol developed by the Lux team. This version introduces post-quantum safety through random corona validation and other cryptographic improvements while maintaining backward compatibility with Warp V1.
