...
var file_decider_decider_proto_rawDesc = []byte{
...
var (
	...
	file_decider_decider_proto_rawDescData = file_decider_decider_proto_rawDesc
)

func file_decider_decider_proto_rawDescGZIP() []byte {
	file_decider_decider_proto_rawDescOnce.Do(func() {
		file_decider_decider_proto_rawDescData = protoimpl.X.CompressGZIP(file_decider_decider_proto_rawDescData)
	})
...
func file_decider_decider_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: file_decider_decider_proto_rawDesc,
			NumEnums:      0,
			NumMessages:   2,
			NumExtensions: 0,
			NumServices:   1,
	...
	file_decider_decider_proto_rawDesc = nil
