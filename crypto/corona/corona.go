// Package corona implements random corona validation for post-quantum safety.
...
// CoronaValidator provides post-quantum safe validation
type CoronaValidator interface {
