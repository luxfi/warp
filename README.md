...
Warp V2 builds upon the original Warp protocol developed by the Avalanche team, adding post-quantum cryptography through random corona validation and private messaging via Z-chain FHE. It defines a message format and cryptographic standard for secure cross-chain communication that is:
